...
// const char *ssid = "ApartDirect-231-5G";            // Enter your Wi-Fi name
// const char *password = "apartdirect2012";  // Enter Wi-Fi password
const char* serverIP = "10.204.0.43"; //Replace with your Python server's IP (e.g. 192.168.1.111)
...
void handleMessage(const String& message) { // This function is set up to receive and parse messages in the form of "TYPE:VALUE" (e.g. Led:55)
  ...
  if (type.equalsIgnoreCase("GREEN_LED")) {
    if (value == 0) {
...
void setup() {
  ...
  digitalWrite(PIN_GREEN_LED, LOW); // start OFF

  pinMode(PIN_YELLOW_LED, OUTPUT);
  digitalWrite(PIN_YELLOW_LED, LOW); // start OFF
